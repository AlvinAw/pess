...
if (isset($_POST["btnDispatch"]))
{
  ...
  $patrolcarDispatched = $_POST["chkPatrolCar"];    //array of being dispatched from post back
  ...
  incident_location, incident_desc, incident_status_id) VALUES('" .$_POST['callerName']."', '".$_POST['contactNo']."',  '
